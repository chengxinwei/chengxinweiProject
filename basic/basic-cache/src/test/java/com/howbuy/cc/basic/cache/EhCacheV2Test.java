...
import com.howbuy.cc.basic.cache.service.EhV2Service;
 ...
 */
public class EhCacheV2Test extends BaseTest {

    @Autowired
    private EhV2Service ehV2Service;

    @Test
    public void ehcacheTest(){
        User user1 = ehV2Service.getUser(1);
        User user2 = ehV2Service.getUser(1);
        Assert.assertEquals(user1, user2);
    }

    @Test
    public void ehcacheTimeoutTest(){
        User user1 =  ehV2Service.getUser1Sec(1);
        try {
            Thread.sleep(1100);
        } catch (InterruptedException e) {
        }
        User user2 = ehV2Service.getUser1Sec(1);
    ...
    public void ehcacheAPITest(){
        User user1 = ehV2Service.getUser(1);
        User user2 = (User) SpringBean.getBean(EhCacheClient.class).get("ehcache.test" , "1");
        Assert.assertEquals(user1, user2);
    }
